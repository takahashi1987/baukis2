...
RSpec.describe "職員による自分のアカウントの管理" do
  before do
  ...
  describe "更新" do
    ...
    example "end_date の値は書き換え不可" do
      ...
      expect { patch staff_account_url, params: { id: staff_member .id, staff_member: params_hash } }.to_not change { staff_member.end_date }
    end
  end
end
