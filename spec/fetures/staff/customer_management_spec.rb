...
feature "職員による顧客管理" do
  ...
  scenario "職員が顧客、自宅住所、勤務先を更新する" do
    ...
    within("fieldset#home-address-fields") do
      fill_in "form_home_address_postal_code", with: "9999999"
      fill_in "form_home_address_address1", with: "テスト一丁目"
    end
  ...
  scenario "職員が顧客、自宅住所、勤務先を追加する" do
    ...
    choose "女性"
    within("fieldset#home-address-fields") do
      fill_in "form_home_address_postal_code", with: "1000001"
